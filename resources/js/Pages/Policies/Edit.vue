<template>
  <AdminLayout title="Chỉnh sửa chính sách" breadcrumb="Chỉnh sửa nội dung chính sách">
    <div class="card">
      <div class="card-header">
        <h5 class="card-title">
          <i class="fas fa-file-contract mr-2"></i>
          Chỉnh sửa: {{ getPolicyTypeText(policy.type) }} -
          {{ policy.app?.name }}
        </h5>
      </div>
      <div class="card-body">
        <form @submit.prevent="submit">
          <div class="row">
            ...
            <div class="col-md-6">
              <div class="alert alert-info mt-3">
                ...
                <strong>Lưu ý:</strong> Việc thay đổi chính sách sẽ ảnh hưởng đến tất cả người dùng của ứng dụng này.
              </div>
            </div>
          </div>
          ...
          <div class="form-group mt-4">
            <button type="submit" class="btn btn-primary" :disabled="form.processing">
              ...
              <i class="fas fa-save mr-1"></i> Cập nhật chính sách
            </button>
...
const submit = () => {
  form.put(route('admin.policies.update', props.policy.id))
}
</script>
